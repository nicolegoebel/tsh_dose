...
st.metric("Your new dose is:", value=f'{st.session_state["new_dose"]} or with random forest {st.session_state["new_dose_rf"]} (exact was {exact_dose_orig} or {exact_dose_orig_rf}) mL', delta=f'{delta} or {delta2} mL')
